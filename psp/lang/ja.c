    ...
    [MENU_ICONS_GAME_FAVORITES] = "お気に入りリスト",
		...
		[MENU_ABOUT_SUPPORT_QR_COFFEE] = "コーヒーを一杯おごる",
		[MENU_ABOUT_SUPPORT_QR_WALLET] = "EVMウォレット",
 ...
 // Help Data
  [HELP_SHOWPASS] = "画面描画に必要なレンダリング呼び出し回数を表示します。\n数値が低いほど高速です。\n下記のハックの効果確認に役立ちます。",
  [HELP_APPLYHACKS] = "データベースに存在する場合、SNESAdvanceのスピードハックを適用します。\nROM読み込み時のみ有効です。",
  [HELP_IGNORE_FIXCOL] = "固定カラーの変更を無視します。\nこれらの変更は画面更新をトリガーしません。\nグラフィックに影響が出る場合があります（グラデーションなど）。",
  [HELP_IGNORE_WINCLIP] = "ウィンドウクリッピングの変更を無視します。\nこれらの変更は画面更新をトリガーしません。\nグラフィックに影響が出る場合があります（表示欠けなど）。",
  [HELP_IGNORE_ADDSUB] = "加算/減算（透明度）効果の変更を無視します。\nこれらの変更は画面更新をトリガーしません。\nグラフィックに影響が出る場合があります（本来透明な部分が不透明になるなど）。",
  [HELP_IGNORE_PALWRITE] = "フレーム中のパレット書き込み変更を無視します。\nこれらの変更は画面更新をトリガーしません。\nグラフィックに影響が出る場合があります（色の異常など）。",
  [HELP_OBJ] = "OBJ（スプライト）の表示オン/オフ。\nスプライト描画を無効にできます。",
  [HELP_BG0] = "BG0 表示オン/オフ。\n背景レイヤー0の描画を無効にできます。",
  [HELP_BG1] = "BG1 表示オン/オフ。\n背景レイヤー1の描画を無効にできます。",
  [HELP_BG2] = "BG2 表示オン/オフ。\n背景レイヤー2の描画を無効にできます。",
  [HELP_BG3] = "BG3 表示オン/オフ。\n背景レイヤー3の描画を無効にできます。",
  [HELP_EASY] = "透過なし。\n透過効果を無効にして描画します。\nグラフィックに影響が出る場合があります（不透明表示など）。",
  [HELP_FASTSPRITE] = "高速スプライト。\nスプライト内の優先度処理を無効化します。\nグラフィックに影響が出る場合があります。",

  // Hack/Debug Menu Labels (Placeholders)
  [DEBUG_MENU_SHOW_PASS] = "描画パス表示 : ",
  [DEBUG_MENU_SPEED_HACKS] = "スピードハック : ",
  [DEBUG_MENU_IGNORE_FIXED_COL] = "固定カラー無視 : ",
  [DEBUG_MENU_IGNORE_WINDOW] = "ウィンドウクリップ無視 : ",
  [DEBUG_MENU_IGNORE_ADDSUB] = "加算/減算無視 : ",
  [DEBUG_MENU_IGNORE_PALETTE] = "パレット書き込み無視 : ",
  [DEBUG_MENU_SIMPLE_PALETTE] = "簡易パレット : ",
  [DEBUG_MENU_OLD_ACCEL] = "旧PSP高速化 : ",
  [DEBUG_MENU_NO_TRANSPARENCY] = "透過なし : ",
  [DEBUG_MENU_FAST_SPRITES] = "高速スプライト : ",
  [DEBUG_MENU_OBJ] = "OBJ : ",
  [DEBUG_MENU_BG0] = "BG0 : ",
  [DEBUG_MENU_BG1] = "BG1 : ",
  [DEBUG_MENU_BG2] = "BG2 : ",
  [DEBUG_MENU_BG3] = "BG3 : ",
  [DEBUG_MENU_SFX_OVERCLOCK] = "SFXオーバークロック : ",
  [MENU_ON] = "オン",
  [MENU_OFF] = "オフ",

  // Input Menu Labels (Placeholders)
  [INPUT_MENU_ANALOG_MAPPED] = "アナログスティックをパッドに割り当て : ",
  [INPUT_MENU_UP] = "上 : ",
  [INPUT_MENU_DOWN] = "下 : ",
  [INPUT_MENU_LEFT] = "左 : ",
  [INPUT_MENU_RIGHT] = "右 : ",
  ...
  [INPUT_MENU_L] = "L : ",
  [INPUT_MENU_R] = "R : ",
  [INPUT_MENU_START] = "スタート : ",
  [INPUT_MENU_SELECT] = "セレクト : ",
  [INPUT_MENU_MENU] = "メニュー : ",
  [INPUT_MENU_TURBO] = "ターボ : ",
  [INPUT_MENU_FSKIPINC] = "フレームスキップ + : ",
  [INPUT_MENU_FSKIPDEC] = "フレームスキップ - : ",
  [INPUT_MENU_GFXENGINE] = "GPUPack.GFXエンジン変更 : ",
  [INPUT_MENU_SAVE_STATE] = "ステート保存 : ",
  [INPUT_MENU_LOAD_STATE] = "ステート読み込み : ",
	},
