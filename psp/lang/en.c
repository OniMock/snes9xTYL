	...
	//english
		...
		[INFO_NO_FAV_GAMES] = "No favorite games added yet!",
		//filer
		...
		[MENU_ICONS_ABOUT_SUPPORT] = "Support",
		[MENU_ABOUT_SUPPORT_FOLLOW] = "Follow the project at:",
		...
		[DEBUG_MENU_SHOW_PASS] = "Show rendering passes: ",
		[DEBUG_MENU_SPEED_HACKS] = "Speed hacks: ",
		[DEBUG_MENU_IGNORE_FIXED_COL] = "Ignore Fixed Colour: ",
		[DEBUG_MENU_IGNORE_WINDOW] = "Ignore Windows clipping: ",
		[DEBUG_MENU_IGNORE_ADDSUB] = "Ignore Add/Sub modes: ",
		[DEBUG_MENU_IGNORE_PALETTE] = "Ignore Palette writes: ",
		[DEBUG_MENU_SIMPLE_PALETTE] = "Simple Palette writes: ",
		[DEBUG_MENU_OLD_ACCEL] = "Old PSP accel.: ",
		[DEBUG_MENU_NO_TRANSPARENCY] = "No Transparency: ",
		[DEBUG_MENU_FAST_SPRITES] = "Fast sprites: ",
		[DEBUG_MENU_OBJ] = "OBJ: ",
		[DEBUG_MENU_BG0] = "BG0: ",
		[DEBUG_MENU_BG1] = "BG1: ",
		[DEBUG_MENU_BG2] = "BG2: ",
		[DEBUG_MENU_BG3] = "BG3: ",
		[DEBUG_MENU_SFX_OVERCLOCK] = "SFX Overclock: ",
		[MENU_ON] = "On",
		[MENU_OFF] = "Off",

		// Input Menu Labels
		[INPUT_MENU_ANALOG_MAPPED] = "Analog stick mapped to pad : ",
		[INPUT_MENU_UP] = "UP : ",
		[INPUT_MENU_DOWN] = "DOWN : ",
		[INPUT_MENU_LEFT] = "LEFT : ",
		[INPUT_MENU_RIGHT] = "RIGHT : ",
		[INPUT_MENU_A] = "A : ",
		[INPUT_MENU_B] = "B : ",
		[INPUT_MENU_X] = "X : ",
		[INPUT_MENU_Y] = "Y : ",
		...
		[INPUT_MENU_FSKIPINC] = "FRAMESKIP + : ",
		[INPUT_MENU_FSKIPDEC] = "FRAMESKIP - : ",
		[INPUT_MENU_GFXENGINE] = "CHANGE GPUPack.GFX ENGINE : ",
		[INPUT_MENU_SAVE_STATE] = "SAVE STATE : ",
		[INPUT_MENU_LOAD_STATE] = "LOAD STATE : ",
	},
