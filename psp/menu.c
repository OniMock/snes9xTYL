...
static int menu_credits(char *mode) {
	...
	for (;;) {
		...
		mh_printLimit(menu_panel_pos+5,135,479,272,"bifuteki (first snes9x port)",GREETINGS_COL);
		...
		mh_printLimit(menu_panel_pos+5,225,479,272,"DraxTube",GREETINGS_COL);
		mh_printLimit(menu_panel_pos+5,235,479,272,"Supporters & Contributors",GREETINGS_COL);
    mh_printLimit(menu_panel_pos+5,245,479,272,"(2026) Maintained by: OniMock",CODE_COL);
