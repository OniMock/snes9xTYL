    ...
    [MENU_ABOUT_SUPPORT_QR_COFFEE] = "Buy Me a Coffee",
		...
		[INIT_OSK] = "正在初始化OSK...",
    // Help Data
    [HELP_SHOWPASS] = "显示渲染屏幕所需的函数调用次数。\n数值越低，速度越快。\n可用于查看下方加速选项的影响。",
    [HELP_APPLYHACKS] = "如果数据库中存在，则应用 SNESAdvance 加速补丁。\n仅在加载 ROM 时生效。",
    [HELP_IGNORE_FIXCOL] = "忽略固定颜色变化。\n这些变化不会触发屏幕刷新。\n可能影响图像效果（如渐变等）。",
    [HELP_IGNORE_WINCLIP] = "忽略窗口裁剪（window clipping）变化。\n这些变化不会触发屏幕刷新。\n可能影响图像效果（如画面缺失等）。",
    [HELP_IGNORE_ADDSUB] = "忽略加/减（透明度）效果变化。\n这些变化不会触发屏幕刷新。\n可能影响图像效果（如透明变为不透明等）。",
    [HELP_IGNORE_PALWRITE] = "忽略帧内调色板写入变化。\n这些变化不会触发屏幕刷新。\n可能影响图像效果（如颜色错误等）。",
    [HELP_OBJ] = "OBJ（精灵）开/关。\n用于禁用精灵渲染。",
    [HELP_BG0] = "BG0 开/关。\n用于禁用背景层 0 渲染。",
    [HELP_BG1] = "BG1 开/关。\n用于禁用背景层 1 渲染。",
    [HELP_BG2] = "BG2 开/关。\n用于禁用背景层 2 渲染。",
    [HELP_BG3] = "BG3 开/关。\n用于禁用背景层 3 渲染。",
    [HELP_EASY] = "无透明效果。\n强制关闭透明渲染。\n可能影响图像效果（像素变为不透明等）。",
    [HELP_FASTSPRITE] = "快速精灵。\n禁用精灵内部优先级处理。\n可能影响图像效果。",

    // Hack/Debug Menu Labels (Placeholders)
    [DEBUG_MENU_SHOW_PASS] = "显示渲染次数 : ",
    [DEBUG_MENU_SPEED_HACKS] = "加速补丁 : ",
    [DEBUG_MENU_IGNORE_FIXED_COL] = "忽略固定颜色 : ",
    [DEBUG_MENU_IGNORE_WINDOW] = "忽略窗口裁剪 : ",
    [DEBUG_MENU_IGNORE_ADDSUB] = "忽略加/减效果 : ",
    [DEBUG_MENU_IGNORE_PALETTE] = "忽略调色板写入 : ",
    [DEBUG_MENU_SIMPLE_PALETTE] = "简化调色板 : ",
    [DEBUG_MENU_OLD_ACCEL] = "旧版PSP加速 : ",
    [DEBUG_MENU_NO_TRANSPARENCY] = "无透明 : ",
    [DEBUG_MENU_FAST_SPRITES] = "快速精灵 : ",
    [DEBUG_MENU_OBJ] = "OBJ : ",
    [DEBUG_MENU_BG0] = "BG0 : ",
    [DEBUG_MENU_BG1] = "BG1 : ",
    [DEBUG_MENU_BG2] = "BG2 : ",
    [DEBUG_MENU_BG3] = "BG3 : ",
    [DEBUG_MENU_SFX_OVERCLOCK] = "SFX超频 : ",
    [MENU_ON] = "开",
    [MENU_OFF] = "关",

    // Input Menu Labels (Placeholders)
    [INPUT_MENU_ANALOG_MAPPED] = "模拟摇杆映射到按键 ：",
    [INPUT_MENU_UP] = "上 ：",
    [INPUT_MENU_DOWN] = "下 ：",
    [INPUT_MENU_LEFT] = "左 ：",
    [INPUT_MENU_RIGHT] = "右 ：",
    ...
    [INPUT_MENU_R] = "R ：",
    [INPUT_MENU_START] = "开始 ：",
    [INPUT_MENU_SELECT] = "选择 ：",
    [INPUT_MENU_MENU] = "菜单 ：",
    [INPUT_MENU_TURBO] = "连发 ：",
    [INPUT_MENU_FSKIPINC] = "跳帧 + ：",
    [INPUT_MENU_FSKIPDEC] = "跳帧 - ：",
    [INPUT_MENU_GFXENGINE] = "切换 GPUPack.GFX 引擎 ：",
    [INPUT_MENU_SAVE_STATE] = "保存状态：",
    [INPUT_MENU_LOAD_STATE] = "读取状态 ：",
	},
